  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        hero: "bg-gradient-desert text-primary-foreground shadow-glow hover:shadow-soft hover:scale-105 transform font-semibold",
        teal: "bg-gradient-teal text-accent-foreground shadow-soft hover:bg-accent/90 hover:shadow-glow",
        floating: "bg-card text-card-foreground shadow-card hover:shadow-glow hover:-translate-y-1 transform border border-border/50"
      },
      size: {
